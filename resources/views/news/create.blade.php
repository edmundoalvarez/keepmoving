...
@section('title', 'Publicar nueva noticia')

@section('content')
<h2 class="mb-2">Publicar una noticia</h2>

@if($errors->any())
<p class="mb-3 text-danger"> Hay errores en la validación. Por favor, corregirlos</p>
@endif

<form class="my-3" action="{{ url('/dashboard/noticias/nuevo')}}" method="POST" enctype="multipart/form-data">
