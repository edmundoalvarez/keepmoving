...
@section('title', 'Carrito usuarios')

@section('content')
  <a class="btn btn-warning btn-volver-cart" href="<?= url('/dashboard/users'); ?>">Volver</a>
    <h2 class="mb-4">Compras del usuario: <b>"{{$user->name}}"</b></h2>
